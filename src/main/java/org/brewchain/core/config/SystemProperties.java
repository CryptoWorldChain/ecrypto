...
import org.brewchain.core.config.blockchain.OlympicConfig;
import org.brewchain.core.config.net.*;
import org.brewchain.core.core.Genesis;
import org.brewchain.core.core.genesis.GenesisConfig;
import org.brewchain.core.core.genesis.GenesisJson;
import org.brewchain.core.core.genesis.GenesisLoader;
import org.brewchain.core.crypto.ECKey;
import org.brewchain.core.net.p2p.P2pHandler;
import org.brewchain.core.net.rlpx.MessageCodec;
import org.brewchain.core.net.rlpx.Node;
import org.brewchain.core.util.BuildInfo;
            ...
            if (genesisJson.getConfig() != null && genesisJson.getConfig().isCustomConfig()) {
                ...
                if (config.hasPath("blockchain.config.name")) {
                    ...
                    try {
                        ...
                        throw new RuntimeException("The class specified via blockchain.config.class '" + className + "' is not instance of org.brewchain.core.config.BlockchainForkConfig", e);
