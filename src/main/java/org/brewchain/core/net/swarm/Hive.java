...
import org.brewchain.core.net.rlpx.discover.table.NodeEntry;
import org.brewchain.core.net.rlpx.discover.table.NodeTable;
import org.brewchain.core.net.swarm.bzz.BzzPeersMessage;
import org.brewchain.core.net.swarm.bzz.BzzProtocol;
import org.brewchain.core.net.swarm.bzz.PeerAddress;
...
//            ret.add(thisPeer.getPeer(new PeerAddress(node)));
     ...
     *  ({@link org.brewchain.core.net.swarm.Hive.HiveTask#expireTime} and a limited number of
     *  peers to process ({@link org.brewchain.core.net.swarm.Hive.HiveTask#maxPeers}).
