...
import static org.brewchain.core.net.message.ReasonCode.REQUESTED;
import static org.brewchain.core.net.message.ReasonCode.UNKNOWN;
import static org.brewchain.core.net.p2p.P2pMessageCodes.DISCONNECT;

/**
 * Wrapper around an Ethereum Disconnect message on the network
 *
 * @see org.brewchain.core.net.p2p.P2pMessageCodes#DISCONNECT
 */
