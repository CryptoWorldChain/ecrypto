...
import org.brewchain.core.trie.Trie;
import org.brewchain.core.trie.TrieImpl;
...
import org.brewchain.core.validator.DependentBlockHeaderRule;
import org.brewchain.core.validator.ParentBlockHeaderValidator;
...
import static org.brewchain.core.core.Denomination.SZABO;
import static org.brewchain.core.core.ImportResult.*;
import static org.brewchain.core.crypto.HashUtil.sha3;
import static org.brewchain.core.util.BIUtil.isMoreThan;
 ...
 */
@Component
public class BlockchainImpl implements Blockchain, org.brewchain.core.facade.Blockchain {
