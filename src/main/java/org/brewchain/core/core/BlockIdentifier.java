...
import static org.brewchain.core.util.ByteUtil.byteArrayToLong;

/**
 * Block identifier holds block hash and number <br>
 * This tuple is used in some places of the core,
 * like by {@link org.brewchain.core.net.eth.message.EthMessageCodes#NEW_BLOCK_HASHES} message wrapper
 *
