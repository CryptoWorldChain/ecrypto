...
//import org.brewchain.ecrypto.address.btc.SigHash;
...
/**
 * A TransactionSignature wraps an {@link BTCKey.ECDSASignature} and adds methods for handling
 * the additional SIGHASH mode byte that is used.
 */
public class TransactionSignature extends BTCKey.ECDSASignature {
    ...
    public TransactionSignature(BTCKey.ECDSASignature signature, SigHash mode, boolean anyoneCanPay) {
    ...
    public static TransactionSignature dummy() {
        BigInteger val = BTCKey.HALF_CURVE_ORDER;
    ...
    @Override
    public BTCKey.ECDSASignature toCanonicalised() {
    ...
    public static TransactionSignature decodeFromBitcoin(byte[] bytes,
        ...
        BTCKey.ECDSASignature sig;
        try {
            sig = BTCKey.ECDSASignature.decodeFromDER(bytes);
