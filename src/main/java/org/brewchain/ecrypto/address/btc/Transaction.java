...
//     */
//    public TransactionInput addSignedInput(TransactionOutPoint prevOut, Script scriptPubKey, BTCKey sigKey,
...
//        BTCKey.ECDSASignature ecSig = sigKey.sign(hash);
...
//
//    /**
//     * Same as {@link #addSignedInput(TransactionOutPoint, Script, BTCKey, Transaction.SigHash, boolean)}
//     * but defaults to {@link SigHash#ALL} and "false" for the anyoneCanPay flag. This is normally what you want.
//     */
//    public TransactionInput addSignedInput(TransactionOutPoint prevOut, Script scriptPubKey, BTCKey sigKey) throws ScriptException {
...
//     * signing key.
//     */
//    public TransactionInput addSignedInput(TransactionOutput output, BTCKey signingKey) {
...
//     * signing key.
//     */
//    public TransactionInput addSignedInput(TransactionOutput output, BTCKey signingKey, SigHash sigHash, boolean anyoneCanPay) {
...
//     */
//    public TransactionOutput addOutput(Coin value, BTCKey pubkey) {
...
//     * followed by {@link BTCKey#sign(Sha256Hash)} and then returning a new {@link TransactionSignature}. The key
...
//     */
//    public TransactionSignature calculateSignature(int inputIndex, BTCKey key,
//                                                                byte[] redeemScript,
...
//     * Calculates a signature that is valid for being inserted into the input at the given position. This is simply
//     * a wrapper around calling {@link Transaction#hashForSignature(int, byte[], Transaction.SigHash, boolean)}
//     * followed by {@link BTCKey#sign(Sha256Hash)} and then returning a new {@link TransactionSignature}.
//     *
//     * @param inputIndex Which input to calculate the signature for, as an index.
//     * @param key The private key used to calculate the signature.
