...
//			System.out.println("sha256="+crypto.sha256(bb).equals(Hex.encodeHexString(bsha256))+"=>" + crypto.sha256(bb)+","+Hex.encodeHexString(bsha256));
//			System.out.println("sha3=" +crypto.sha3(bb).equals(Hex.encodeHexString(bsha3))+"=>"+ crypto.sha3(bb)+","+Hex.encodeHexString(bsha3));
//			System.out.println("md5=" +crypto.md5(bb).equals(Hex.encodeHexString(bmd5))+"=>"+ crypto.md5(bb)+","+Hex.encodeHexString(bmd5));
//			System.out.println("keccak="+crypto.keccak(bb).equals(Hex.encodeHexString(bkeccak))+"=>" + crypto.keccak(bb)+","+Hex.encodeHexString(bkeccak));
		}
	}
